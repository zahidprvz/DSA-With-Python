...
print("\n\nDLL after poping the node: ")
my_d_ll.pop()
my_d_ll.print_list()

print("\n\nDLL after prepending a node: ")
my_d_ll.prepend(-1)
my_d_ll.print_list()

print("\n\nAfter popping_first element: ")
my_d_ll.pop_first()
my_d_ll.print_list()

print("\n\nThe element at index 2 is: ", my_d_ll.get(2))

print("\n\nAfter changing the element at index 2: ")
my_d_ll.set_value(2, 143)
my_d_ll.print_list()
